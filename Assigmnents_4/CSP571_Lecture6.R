...
# Notice how adding an intercept is the equivilant of adding 
# a column of 1's to the X matrix
# TODO: Clarify how adding the 2 constant is different than the 1
...
# Compute our Yhat
yHat <- X %*% beta
# Compute our sum of squared errors = sum squared residuals
SSE <- sum((Y - yHat)**2)
...
load("F:/Assigmnents/DPA/Assigmnents_4/psub.RData")
head(psub)
class(psub$PINCP)
...
# income level (PINCP)
# Taken form this site: https://github.com/WinVector/zmPDSwR/tree/master/PUMS
...
library('caret')
# Why am I using createDataPartition
...
# Clarify what is the X and Y matrix here on whiteboard
...
SSR/SST # Notice difference in test set and train set
